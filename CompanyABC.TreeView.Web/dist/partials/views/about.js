...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('/partials/views/about.html',
    ...
    '            <ul>\n' +
    '                <li>Visual Studio 2012/2013/2015 (I haven\'t tested it in VS 2013 or 2015, as I haven\'t downloaded the express versions to my home machine yet as I\'ve been playing more with NodeJs modules, but I\'m almost sure it\'ll be fine).</li>\n' +
    '                <li>To have the .js tests running in test explorer, you\'ll need to install the <a href="https://visualstudiogallery.msdn.microsoft.com/f8741f04-bae4-4900-81c7-7c9bfb9ed1fe">Chutzpah Test Adapter for the Test Explorer</a> and optionally the <a href="https://visualstudiogallery.msdn.microsoft.com/71a4e9bd-f660-448f-bd92-f5a65d39b7f0">Chutzpah Test Runner Context Menu Extension</a> extensions for Visual Studio.</li>\n' +
    '                <li>\n' +
